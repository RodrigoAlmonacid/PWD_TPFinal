...
<div class="container my-5">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?= $ruta ?>/vista/productoEspeciales.php" class="text-decoration-none text-dark">Especiales</a></li>
            <li class="breadcrumb-item active" aria-current="page">Baterías</li>
        </ol>
    </nav>
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-4">
            <div class="card shadow-sm border-0">
                <img src="imagenes/pilaEspecialD2.jpg" class="img-fluid p-4 rounded" alt="Batería 9v">
            </div>
            
            <div class="d-flex justify-content-center mt-3">
                <img src="imagenes/pilaEspecialD2_3.jpg" alt="Vista 1" class="img-thumbnail me-2" style="width: 80px; cursor: pointer;">
                <img src="imagenes/pilaEspecialD2_2.jpg" alt="Vista 2" class="img-thumbnail me-2" style="width: 80px; cursor: pointer;">
            </div>
        </div>
        
        <div class="col-md-6">
            <h1 class="fw-bold">Pila especial D2</h1>
