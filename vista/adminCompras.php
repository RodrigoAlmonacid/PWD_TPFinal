        ...
        <?php if (in_array(2, $rolesUsuarioSimple)){ ?>
            <div class="card shadow-lg p-4">
                ...
                <table id="dg" title="Compras" class="easyui-datagrid" style="width:900px;height:250px alig"
                        url="accion/accionListaCompras.php?usuario=admin"
            ...
            <div id="dlg-buttons">
                <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" onclick="cambiarEstado('Aprobada')">Aprobar Compra</a>
                ...
                <div class="card shadow-lg p-3 mb-5 bg-body-tertiary rounded text-center" style="max-width: 500px; width: 100%;">
                    <div class="card-body p-5">
                        ...
                        <p class="card-text text-muted mb-4 fs-5">
                            No posee los permisos necesarios para acceder al módulo de <strong>Administración de Compras</strong>.
                        </p>
