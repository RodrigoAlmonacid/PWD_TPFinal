Base de datos para el TP final: nombre= 'bdcarritocompras'
...
ALTER TABLE producto ADD proprecio INT NOT NULL DEFAULT 0, ADD prodeshabilitado TINYINT(1) NOT NULL DEFAULT 0;
ALTER TABLE producto ADD proimagen VARCHAR(255) NOT NULL;
